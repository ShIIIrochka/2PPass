...
def get_settings() -> dict:
	...
	jazzmin_settings["hide_apps"] = [
		x.lower() for x in jazzmin_settings["hide_apps"]
	]
	...
	jazzmin_settings["changeform_format_overrides"] = {
		x.lower(): y.lower()
		for x, y in jazzmin_settings.get(
			"changeform_format_overrides", {}
		).items()
	}
...
def get_ui_tweaks() -> dict:
	...
	ret = {
		...
		"navbar_classes": classes(
			"navbar", "no_navbar_border", "navbar_small_text"
		),
